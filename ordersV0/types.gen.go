...
type ShipmentOrderItemList []ShipmentOrderItem
...
type ShipmentPackageDetail struct {
...
// GetOrderItemsBuyerInfoParams defines parameters for GetOrderItemsBuyerInfo.
type CreateShipmentConfirmationBody struct {
	// The identifier for the marketplace where the order was placed.
	MarketplaceId string `json:"marketplaceId,omitempty"`

	//Properties of packages
	PackageDetail ShipmentPackageDetail `json:"packageDetail,omitempty"`
}
